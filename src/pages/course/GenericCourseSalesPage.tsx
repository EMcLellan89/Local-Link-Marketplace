...
export default function GenericCourseSalesPage() {
  ...
  useEffect(() => {
    ...
    if (refCode) {
      ...
      const stored = localStorage.getItem(`ll_course_ref_${courseSlug}`);
  ...
  function loadDevModeCourse() {
    if (courseSlug === 'online-sales-without-ads') {
      setCourse({
        id: 'dev-course-1',
      ...
      setModules([
        { id: 'module-1', module_index: 1, title: 'Module 1: Foundation', description: 'Build the foundation for your sales success without ads' },
        { id: 'module-2', module_index: 2, title: 'Module 2: Lead Generation', description: 'Master the art of finding and qualifying leads' },
        { id: 'module-3', module_index: 3, title: 'Module 3: Outreach Systems', description: 'Create repeatable outreach systems that convert' },
        { id: 'module-4', module_index: 4, title: 'Module 4: Scaling', description: 'Scale your sales process predictably' },
      ]);

      setProduct({ slug: 'online-sales-without-ads', title: 'Online Sales Without Ads™', price_cents: 19700 });
    } else if (courseSlug === 'ugc-from-home') {
      setCourse({
        id: 'dev-course-2',
        title: 'UGC From Home™',
        subtitle: 'How SAHMs get paid creating UGC content—no followers required.',
        description: 'Step-by-step system for stay-at-home moms to earn $500-$2000/month creating user-generated content for brands. No following needed. Includes certification exam.',
      });

      setModules([
        { id: 'module-1', module_index: 1, title: 'What UGC Really Is (And Isn\'t)', description: 'Understand UGC and how it differs from influencer work' },
        { id: 'module-2', module_index: 2, title: 'Who Pays SAHMs for UGC', description: 'Pick niches and brands that buy UGC consistently' },
        { id: 'module-3', module_index: 3, title: 'Filming Content at Home', description: 'Simple setup, shots, and content types brands want' },
        { id: 'module-4', module_index: 4, title: 'Build a Simple Portfolio', description: 'Create a portfolio with zero clients using samples' },
        { id: 'module-5', module_index: 5, title: 'Find Brands That Pay', description: 'Outreach channels + lists + daily pipeline' },
        { id: 'module-6', module_index: 6, title: 'Getting Paid (Pricing + Deals)', description: 'Rate cards, packages, usage rights' },
        { id: 'module-7', module_index: 7, title: 'Turn It Into Monthly Income', description: 'Retainers, batching, scaling without burnout' },
        { id: 'module-8', module_index: 8, title: 'Your First 30 Days Plan', description: 'Weekly checklist from practice to first paid work' },
      ]);

      setProduct({ slug: 'ugc-from-home', title: 'UGC From Home™', price_cents: 19700 });
    }
  ...
  async function handleEnroll() {
    if (!user) {
      navigate(`/login?redirect=/marketplace/products/${courseSlug}`);
      return;
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl shadow-xl p-12 text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join hundreds of people who have transformed their business with this course
            </p>
            <button
              onClick={handleEnroll}
              disabled={enrolling}
