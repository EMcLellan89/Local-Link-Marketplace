...
export default function AIFollowUpAutomationPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI Follow-Up Automation assistant. I can help you create follow-up sequences, review request campaigns, or lead nurture workflows. What type of follow-up would you like to automate?"
    }
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/ai-follow-up-automation`,
        {
          method: 'POST',
          headers: {
  ...
  const followUpExamples = [
    {
      ...
      prompt: 'Create a 3-touch follow-up sequence for roofing quotes sent but not accepted',
      icon: '📧'
    },
    {
      title: 'Review Request',
      prompt: 'Setup automated review requests 3 days after job completion for plumbing services',
      icon: '⭐'
    },
    {
      title: 'Cold Lead Re-engagement',
      prompt: 'Build a campaign to re-engage leads from last summer who didn\'t convert',
      icon: '🔄'
    },
    {
      title: 'Seasonal Offer',
      prompt: 'Create spring HVAC maintenance offer campaign for past customers',
      icon: '🌸'
    }
  ];
  ...
  return (
    <BusinessHubLayout>
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">AI Follow-Up Automation</h1>
          <p className="text-slate-600 mt-2">
            Never lose a deal to lack of follow-up. Automate your entire follow-up process.
          </p>
        </div>
              ...
              <CardBody>
                ...
                <form onSubmit={handleSubmit} className="flex gap-2">
                  <input
                    ...
                    placeholder="Describe your follow-up automation needs..."
          ...
          <div className="space-y-6">
            <Card variant="bordered" className="bg-gradient-to-br from-blue-50 to-cyan-50">
              <CardHeader>
                ...
                <h3 className="text-lg font-bold text-slate-900">Automation Types</h3>
              </CardHeader>
              <CardBody>
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>✓ Quote follow-ups</li>
                  <li>✓ Review requests</li>
                  <li>✓ Cold lead re-engagement</li>
            ...
            <Card variant="bordered">
              <CardHeader>
                <h3 className="text-lg font-bold text-slate-900">Campaign Examples</h3>
              </CardHeader>
              <CardBody>
                <div className="space-y-2">
                  {followUpExamples.map((example, index) => (
                    <button
                      key={index}
            ...
            <Card variant="bordered" className="bg-gradient-to-br from-green-50 to-emerald-50">
              <CardBody>
                ...
                <ul className="space-y-1 text-sm text-slate-600">
                  <li>✓ Increase close rate by 30%+</li>
                  <li>✓ More 5-star reviews</li>
                  <li>✓ Recover lost opportunities</li>
