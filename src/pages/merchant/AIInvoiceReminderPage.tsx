...
import { DollarSign, Send, Copy, Check } from 'lucide-react';
...
export default function AIInvoiceReminderPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI Invoice Reminder assistant. I help you get paid faster with automated payment reminders and professional collection workflows. What type of invoice automation do you need?"
    }
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/ai-invoice-reminder`,
        {
          method: 'POST',
          headers: {
  ...
  const reminderExamples = [
    {
      title: 'Net 30 Reminders',
      prompt: 'Setup reminder sequence: friendly notice at day 25, firm at day 35, final at day 45',
      icon: '📅'
    },
    {
      title: 'Payment Plans',
      prompt: 'Create automated payment plan offers for invoices over $5,000 that are 30+ days overdue',
      icon: '💳'
    },
    {
      title: 'Multi-Channel',
      prompt: 'Setup reminders via email on day 1, SMS on day 7, phone call on day 14',
      icon: '📱'
    },
    {
      title: 'Good Customer Care',
      prompt: 'Friendly reminder system for reliable customers with grace period',
      icon: '🤝'
    }
  ];
  ...
  return (
    <BusinessHubLayout>
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">AI Invoice Reminder</h1>
          <p className="text-slate-600 mt-2">
            Get paid faster without awkward conversations. Professional automated reminders.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardBody>
                ...
                <form onSubmit={handleSubmit} className="flex gap-2">
                  <input
                    ...
                    placeholder="Describe your invoice reminder needs..."
          ...
          <div className="space-y-6">
            ...
            <Card variant="bordered">
              <CardHeader>
                <h3 className="text-lg font-bold text-slate-900">Reminder Templates</h3>
              </CardHeader>
              <CardBody>
