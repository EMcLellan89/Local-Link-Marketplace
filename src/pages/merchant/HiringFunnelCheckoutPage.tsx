...
import { Users, CreditCard, Lock, ArrowLeft, CheckCircle } from 'lucide-react';
...
const templateDetails = {
  retail: {
    ...
    description: 'Pre-configured for retail and customer-facing positions',
    features: [
  ...
  restaurant: {
    ...
    description: 'Optimized for front and back-of-house positions',
    features: [
  ...
  professional: {
    ...
    description: 'For office, admin, and professional roles',
    features: [
      'Detailed application review',
      'Skills testing templates',
      'Multi-round interview guides',
  ...
  custom: {
    ...
    description: 'Create your own customized hiring process',
    features: [
...
export default function HiringFunnelCheckoutPage() {
  ...
  const selectedTemplate = location.state?.selectedTemplate || 'retail';
  const template = templateDetails[selectedTemplate as keyof typeof templateDetails];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const paymentData = {
        ...
        orderId: order.id,
        orderType: 'hiring_funnel',
        returnUrl: `${window.location.origin}/merchant/recruiting/hiring-funnel-confirmation`
      };
              ...
              <CardBody className="space-y-4">
                ...
                <div className="border-t border-slate-200 pt-4 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-slate-900">$750.00</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-lg font-bold border-t border-slate-200 pt-2">
                    ...
                    <span className="text-[#2BB673]">$750.00</span>
                  </div>
                </div>

                <div className="bg-[#2BB673]/5 rounded-lg p-3">
                  <p className="text-xs text-slate-600">
                    Lifetime access with all updates included. Setup assistance available.
                  </p>
                </div>
              </CardBody>
            </Card>
