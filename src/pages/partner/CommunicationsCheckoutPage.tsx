...
export default function CommunicationsCheckoutPage() {
  ...
  async function handleCheckout() {
    ...
    try {
      ...
      navigate('/partner/dashboard?communications=activated');
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Choose the communication tools you need to connect with your merchants
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4">
                Send professional email campaigns to your merchant prospects
              </p>
