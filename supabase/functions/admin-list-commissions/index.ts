...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(`
        *,
        order:marketplace_orders(id, total_cents, customer_email),
        partner:marketplace_partners(id, display_name, referral_code, tier)
      `, { count: "exact" })
    ...
    return new Response(
      JSON.stringify({ error: error.message || "Failed to list commissions" }),
